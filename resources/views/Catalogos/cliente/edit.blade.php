...
@section('content')
    <section class="content container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" action="{{ route('clientes.update', $cliente) }}" role="form"
                    enctype="multipart/form-data" id="formulario-cliente" autocomplete="off">
                    {{ method_field('PATCH') }}
                    @csrf
    ...
    <x-modals.confirm text="Editar" idButton="button-cliente" />
...
@section('js')
    <script>
        ...
        $('#expediente').bootstrapSwitch({
            onText: "Solocita expediente para iniciar con las esitmaciones",
            offText: 'No solicita'
        });
        $.validator.addMethod(
            "regex",
