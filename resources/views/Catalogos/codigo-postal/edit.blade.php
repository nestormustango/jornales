...
@section('content_header')
    {{ Breadcrumbs::render('codigoPostal.update', $codigoPostal) }}
@stop
...
@section('content')
            ...
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Editar Codigo Postal</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('codigos-postales.update', $codigoPostal) }}" role="form"
    ...
    <x-modals.confirm text="Editar" idButton="button-cp" />
@stop
    ...
    <script>
        $("#button-cp").click(function() {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "{{ route('codigos-postales.update', $codigoPostal) }}",
                dataType: 'json',
                data: formData,
                processData: false,
                contentType: false,
