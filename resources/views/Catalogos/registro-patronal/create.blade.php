...
@section('content_header')
    {{ Breadcrumbs::render('registroPatronal.store') }}
@stop
            ...
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="card-header">
                        <span class="card-title">Agregar Registro Patronal</span>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('registros-patronales.store') }}" role="form"
